...
--------------------------------------------------------------------
local Library = Update:Window("GHOSTHUB ","")
------------------------------------------
...
Main:Seperator(" Ilha Da Miragem 🏝️ | GHOSTCK SCRIPTS |")
...
Main:Toggle("Auto Miragem Hop(MANUTENÇAO!)",false,function(value)
 _G.Mystichop = value
end)

Main:Seperator(" Baú📦 ")

Main:Toggle("Auto Pegar Baú Rápido(BAN RISK)",false,function(vu)
	_G.ChestBypass = vu
end)
...
wait(1)
Notification:Notify(
   {Title = "GHOST HUB", Description = "You Have Max Observation"},
...
Weapon:Seperator(" Missões📜 | GHOST SCRIPTS |")
...
spawn(function()
 ...
 DevilFruit:Seperator(" outros | Ghost script |  ")
